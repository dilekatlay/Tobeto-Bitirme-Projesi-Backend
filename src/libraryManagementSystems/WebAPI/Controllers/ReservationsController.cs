...
using Application.Features.Reservations.Queries.GetListByMemberId;
...
public class ReservationsController : BaseController
{
    ...
    // Apply authorization based on roles defined in the query
    public async Task<ActionResult<GetListResponse<GetListReservationListItemDto>>> GetListByMemberId(Guid memberId, [FromQuery] PageRequest pageRequest)
    {
        var query = new GetListByMemberIdReservationQuery
        {
            Id = memberId,

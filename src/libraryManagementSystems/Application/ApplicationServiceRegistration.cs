...
using Application.Services.CargoInformations;
using Application.Services.CargoTrackings;
using Application.Services.CreditCarts;
using Application.Services.Managements;
using Application.Services.Employees;
using Application.Services.InventoryManagements;
using Application.Services.Books;
using Application.Services.Shelves;
...
public static class ApplicationServiceRegistration
{
    ...
    )
    {
        ...
        services.AddScoped<ICargoInformationService, CargoInformationManager>();
        services.AddScoped<ICargoTrackingService, CargoTrackingManager>();
        services.AddScoped<ICreditCartService, CreditCartManager>();
        services.AddScoped<IOrderService, OrderManager>();
        services.AddScoped<IManagementService, ManagementManager>();
        services.AddScoped<IEmployeeService, EmployeeManager>();
        services.AddScoped<IInventoryManagementService, InventoryManagementManager>();
        services.AddScoped<ICargoInformationService, CargoInformationManager>();
        services.AddScoped<ICargoTrackingService, CargoTrackingManager>();
        services.AddScoped<ICreditCartService, CreditCartManager>();
        services.AddScoped<IEmployeeService, EmployeeManager>();
